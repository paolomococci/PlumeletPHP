<? $this->layout('dashboard', ['title' => 'Item - Index']) ?>
                ...
                <tbody>
                    <? foreach ($items as $item): ?>
                        <tr>
                            ...
                            <td><a style="text-decoration: none" href="/admin/item/update/<?= $this->e($item->getId()) ?? '' ?>">edit</a></td>
                            <td><a style="text-decoration: none" href="/admin/item/delete/<?= $this->e($item->getId()) ?? '' ?>">del</a></td>
                        </tr>
                    <? endforeach; ?>
                </tbody>
            </table>
